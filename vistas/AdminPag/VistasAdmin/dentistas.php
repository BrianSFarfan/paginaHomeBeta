             ...
             <form class="d-flex">
               ...
               <button type="button" class="btn btn-primary" style="border-radius:50px;" data-bs-toggle="modal" data-bs-target="#AgregarPersona">
                ...
                <div class="col-9 d-flex" >
                    ...
                    <button class="btn btn-outline-primary" style="border-radius: 50px;" type="submit"><i class="bi bi-search"></i></button>
                </div>
             </form>
<br>
                      ...
                      <table class="table  table-bordered border-primary">
                        ...
                        <!--FIN DE HEAD-->
                              <tbody>
                                ...
                                <?php foreach($conexion->query('SELECT * FROM doctores') as $row){?>
                                <tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-danger">
        <h5 class="modal-title" id="staticBackdropLabel" style="color: #fff;">Elimnar Dentista</h5>
      </div>
